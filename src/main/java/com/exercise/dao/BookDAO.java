...
public class BookDAO {
	...
	public int insertData(BookRequestDTO dto) {
		...
		result = jdbcTemplate.update(sql, dto.getBookCode(), dto.getBookTitle(), dto.getBookAuthor(),
				dto.getBookPrice());
		return result;
	}
	...
	public int updateData(BookRequestDTO dto) {
		...
		result = jdbcTemplate.update(sql, dto.getBookTitle(), dto.getBookAuthor(), dto.getBookPrice(),
				dto.getBookCode());
		return result;
	}
	...
	public BookResponseDTO selectOne(BookRequestDTO dto) {
		...
		return jdbcTemplate.queryForObject(sql, (rs, rowNum) -> new BookResponseDTO(rs.getString("book_code"),

				rs.getString("book_title"),

				rs.getString("book_author"),

				rs.getString("book_price")), dto.getBookCode());
	}

	public List<BookResponseDTO> selectAll() {
		String sql = "select * from book";
		return jdbcTemplate.query(sql, (rs, rowNum) -> new BookResponseDTO(rs.getString("book_code"),
				rs.getString("book_title"), rs.getString("book_author"), rs.getString("book_price")));
	}
}
